...
*/
function getArtistByIndex(arr, inde) {
 
  
  return `The artist at index ${arr[inde].id} is ${arr[inde].name}.`
}
...
*/
function removeArtist(arr,removeinde) {
...
addArtist(20,'Devon','1995 - 2020','Future Bass', 'Mixed', 'Going to be the best coder ever.')
...
function lotsOfArt(arr){
  ...
  for(i = 0; i < arr.length; i++){
    if(arr[i].paintings > 100){
      moreThanOneHundred.push(arr[i].name);
    }
}
